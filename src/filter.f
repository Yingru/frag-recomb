...
!     &          /)
      ...
      tempTab = (/0.165d0,0.165d0,0.165d0,0.165d0,0.166d0,0.166d0,
     &            0.167d0,0.168d0,0.168d0,0.169d0,0.171d0,0.172d0,
     &            0.174d0,0.176d0,0.179d0,0.182d0,0.186d0,0.192d0,
     &            0.202d0,0.219d0/)

      max_ud = (/0.065d0,0.067d0,0.068d0,0.069d0,0.071d0,0.073d0,
     &           0.074d0,0.076d0,0.077d0,0.079d0,0.081d0,0.082d0,
     &           0.084d0,0.085d0,0.087d0,0.089d0,0.090d0,0.092d0,
     &           0.094d0,0.095d0,0.097d0,0.099d0,0.101d0,0.103d0,
     &           0.104d0,0.106d0,0.108d0,0.110d0,0.112d0,0.114d0,
     &           0.116d0,0.118d0,0.120d0,0.122d0,0.124d0,0.126d0,
     &           0.128d0,0.130d0,0.133d0,0.135d0,0.137d0,0.139d0,
     &           0.141d0,0.143d0,0.146d0,0.148d0,0.150d0,0.153d0,
     &           0.155d0,0.157d0,0.160d0,0.162d0,0.164d0,0.167d0,
     &           0.169d0/)
...
c boost to the local rest frame of cell for recombination
     ...
     &                    p_px(ipin),p_py(ipin),p_pz(ipin),p_p0(ipin))
               ...
               ind_temp = int((temp_cell-0.165d0)/0.001d0+0.5d0)
               temp_common = 0.165d0+ind_temp*0.001d0
